  ...
  const html = `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="margin-top: 30px; font-size: 12px; color: #666;">
        Este es un mensaje automático del Gestor de Tareas.
        <br>
        <a href="${nodemailer.getTestMessageUrl({} as any)}">Ver mensaje en Ethereal</a>
      </p>
    </div>
  `;

  const info = await transporter.sendMail({
    from: '"TaskPro Bot" <noreply@taskpro.com>',
    to,
